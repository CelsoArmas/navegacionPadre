		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Aplicacion Origen",
									"targetURL": "#comtasamodule1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comtasamodule1-display": {
								"semanticObject": "comtasamodule1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tasa.module1",
									"url": sap.ui.require.toUrl("com/tasa/module1")
								}
							}
						}
					}
